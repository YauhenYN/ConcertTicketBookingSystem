...
namespace UnitTests
{
    public class ConcertsControllerTests
    {
        ...
        ////            controller.ControllerContext.HttpContext.User = new ClaimsPrincipal(ConcertTicketBookingSystemAPI.Helpers.JwtAuth.AuthOptions.GetIsAdminIdentity(Guid.NewGuid(), false));
        ////            //Act
