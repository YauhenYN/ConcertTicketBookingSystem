...
namespace ConcertTicketBookingSystemAPI.CustomServices.OAuth
{
    public class FacebookOAuthService
    {
        ...
        public FacebookOAuthService(string clientId, string secret, string oAuthServerEndPoint, string tokenEndPoint, string refreshEndPoint, string googleApiEndPoint)
        {
            _clientId = clientId;
            _secret = secret;
